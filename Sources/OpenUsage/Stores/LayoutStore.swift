...
final class LayoutStore {
    ...
    func updateRegistry(
        ...
        metricOrderByProvider = LayoutOrdering.normalizedMetricOrder(metricOrderByProvider, registry: registry)
    ...
    static func migrateCodexAccountCreditPins(_ pins: Set<String>) -> Set<String> {
        var migrated = pins
